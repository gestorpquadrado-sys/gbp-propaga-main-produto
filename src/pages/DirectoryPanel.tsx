...
import { Building2, ArrowLeft, CheckCircle2, Mail, XCircle, Clock, RefreshCw, ClipboardList, SearchCheck, SearchX, ExternalLink } from 'lucide-react';
                      ...
                      <div className="flex-1">
                        ...
                        {result.verificationStatus && (
                          <p className="text-xs text-muted-foreground mt-1">
                            ...
                            {result.profileUrl ? ' • Perfil encontrado' : ''}
                          </p>
                        )}
                        <div className="flex flex-wrap gap-2 mt-2">
                          {result.profileUrl && (
                            <a href={result.profileUrl} target="_blank" rel="noreferrer" className="text-xs inline-flex items-center gap-1 text-accent hover:underline">
                              Abrir perfil <ExternalLink className="h-3 w-3" />
                            </a>
                          )}
                          {!result.profileUrl && result.formUrl && (
                            <a href={result.formUrl} target="_blank" rel="noreferrer" className="text-xs inline-flex items-center gap-1 text-amber-300 hover:underline">
